...
export function SensoresIoTIA() {
  ...
  const handleGenerateAISuggestions = async () => {
    ...
    const mockSuggestion = {
      id: `ai-${Date.now()}`,
      fincaId: userFincas[0]?.id || "",
      loteId: userLotes[0]?.id || "",
      loteName: userLotes[0]?.name || "Lote 1",
                ...
                <div key={suggestion.id} className="bg-white p-4 rounded-lg border border-purple-200">
                  <div className="flex items-start justify-between mb-3">
                    <div className="flex items-center gap-2">
                      ...
                      <span className="text-sm text-gray-600">{userFincas[0]?.name}</span>
                    </div>
                  </div>
                  ...
                  <div className="flex gap-3">
                    ...
                    <Button variant="outline" onClick={() => handleDiscardSuggestion(suggestion.id)}>
                      Descartar
                    </Button>
                  </div>
                </div>
              ...
              <div className="grid gap-4 md:grid-cols-2">
                {airSensors.length === 0 ? (
                  <div className="col-span-2 text-center py-8">
                    ...
                    <p className="text-gray-500">No hay sensores de aire disponibles</p>
                  </div>
                ) : (
                    ...
                    return (
                      <Card key={sensor.id} className="border-2">
                        <CardHeader className="pb-3">
                          <div className="flex items-center justify-between">
                            <div className="flex items-center gap-2">
                              ...
                              <CardTitle className="text-base">
                                {sensor.type === "temperature" ? "Sensor Temperatura Aire" : "Sensor Humedad Aire"}{" "}
                                {lote?.name}
                              </CardTitle>
                            </div>
                          ...
                          <CardDescription className="text-sm">{finca?.name}</CardDescription>
                        </CardHeader>
                        <CardContent>
                          ...
                          <div className="mt-4 space-y-2 text-sm">
                            ...
                            <div className="flex justify-between">
                              <span>Device ID:</span>
                              <span className="font-mono">{sensor.deviceId || "AIR_001"}</span>
                            </div>
                            <div className="flex justify-between">
                      ...
                      <Card key={sensor.id} className="border-2">
                          ...
                          <div className="flex items-center justify-between">
                            <div className="flex items-center gap-2">
                              ...
                              <CardTitle className="text-base">
                                ...
                                {sensor.type === "ph" && "Sensor pH Suelo"} {lote?.name}
                              </CardTitle>
                            </div>
                            <Badge variant={sensor.status === "online" ? "default" : "destructive"}>
                              {sensor.status === "online" ? "Activo" : "Inactivo"}
                        ...
                        <CardContent>
                          ...
                          <div className="space-y-2 text-sm">
                            <div className="flex justify-between">
                              <span>Device ID:</span>
                              <span className="font-mono">{sensor.deviceId || "SOIL_001"}</span>
                            </div>
                            <div className="flex justify-between">
                              <span>Última lectura:</span>
                              <span>
                      ...
                      <Card key={sensor.id} className="border-2">
                        <CardHeader className="pb-3">
                          <div className="flex items-center justify-between">
                            <div className="flex items-center gap-2">
                              ...
                              <CardTitle className="text-base">
                                {sensor.type === "flow" ? "Sensor Flujo" : "Sensor Presión"} Válvula {lote?.name}
                              </CardTitle>
                            </div>
                            <Badge variant={sensor.status === "online" ? "default" : "destructive"}>
                              {sensor.status === "online" ? "Activo" : "Inactivo"}
                        ...
                        <CardContent>
                          ...
                          <div className="space-y-2 text-sm">
                            ...
                            <div className="flex justify-between">
                              <span>Device ID:</span>
                              <span className="font-mono">{sensor.deviceId || "WATER_001"}</span>
                            </div>
                            <div className="flex justify-between">
                              <span>Última lectura:</span>
                              <span>
